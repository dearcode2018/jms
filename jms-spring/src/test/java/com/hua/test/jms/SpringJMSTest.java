...
public final class SpringJMSTest extends BaseTest {
	...
	/**
	 * 指定使用的目的地，如果此处指定了jmsContainer没有
	 * 配置的destination，则无法监听该消息，从而让接受者
	 * 作出响应.
	 */
	 ...
	 */
	@Test
	public void testProduceService() {
		try {
			String message = "上海世博会开幕.";
			produceService.sendMessage(destination, message);
			
		} catch (Exception e) {
			log.error("testProduceService =====> ", e);
		}
	}
